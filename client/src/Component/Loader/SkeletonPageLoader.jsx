      ...
      <div className="flex items-start w-full">
        <div className="tablet-lg:w-[115px] tablet-xl:w-[125px] tablet-largexl:w-[155px] tablet:w-0 bg-white">
          <aside className="scrollbar bg-white h-screen overflow-y-auto top-0 tablet-lg:relative tablet-lg:bg-transparent tablet-lg:block tablet-lg:z-auto">
            <div className="pb-16 h-fullbg-artisan-white-15 shadow tablet-lg:pb-6 tablet-lg:w-[115px] tablet-xl:w-[125px] tablet-largexl:w-[155px] mobile-sm:w-full w-full">
              <div className=" bg-artisan-white-15 animate-pulse h-[105px] fixed tablet-lg:w-[115px] tablet-xl:w-[125px] tablet-largexl:w-[155px] z-30 mobile-sm:w-5/12 w-6/12">
                <div className=" w-full flex justify-center items-center h-full">
                  <div className="h-[55px] w-[55px] bg-artisan-dark-grey-15 mt-3 animate-pulse rounded-full"></div>
                </div>
                <div className="flex flex-col gap-9">
                  <div className="h-[80px] w-[155px] animate-plus bg-artisan-dark-grey-15 pr-7"></div>
                  <div className="h-[80px] w-[155px] animate-plus bg-artisan-dark-grey-15 pr-7"></div>
                  <div className="h-[80px] w-[155px] animate-plus bg-artisan-dark-grey-15 pr-7"></div>
                  <div className="h-[80px] w-[155px] animate-plus bg-artisan-dark-grey-15 pr-7"></div>
                  <div className="h-[80px] w-[155px] animate-plus bg-artisan-dark-grey-15 pr-7"></div>
        ...
        <div className="flex flex-col w-full tablet-lg:w-[100%] tablet-xl:w-[100%] tablet-xl:px-0 h-screen pl-0 tablet-lg:space-y-4">
          <nav className="h-[105px] border-gray-200 rounded left-0 shadow-md w-full relative tablet-lg:bg-artisan-white-15">
            <div className=" flex h-[105px] mx-auto w-full tablet-xl:pl-[50%] pt-[1%] gap-20">
              <div className="h-[55px] w-[55px] bg-artisan-dark-grey-15 animate-pulse rounded-full"></div>
              <div className="h-[55px] w-[55px] bg-artisan-dark-grey-15 animate-pulse rounded-full"></div>
              <div className="h-[55px] w-[55px] bg-artisan-dark-grey-15 animate-pulse rounded-full ml-7"></div>
              <div className="h-[55px] w-48 bg-artisan-dark-grey-15 border-gainsbro-600 rounded-full flex items-center justify-center gap-2  cursor-pointer mr-20 "></div>
              <div className="h-[55px] w-[55px] bg-artisan-dark-grey-15 animate-pulse rounded-full"></div>
            </div>
          </nav>
